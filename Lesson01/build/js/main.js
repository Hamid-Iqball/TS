...
//######################################
class Coder {
    constructor(name, // Public is called Data modifier this makes our code a little but DRY.
    music, age, // only acessiable in this class
    lang = 'TypeScript' // Lang can be access inside the class but it can also be access in derived classes as well.This is difference between Private and protected
    ) {
        this.name = name;
        this.music = music;
        this.age = age;

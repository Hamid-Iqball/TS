...
const stringEcho = (arg) => arg; // The problem with this is that it only accept string.
const echo = (arg) => arg; //This is the more generic type and this works for any other type as well, we can write anything else of T as well.
//example funciton
const isObj = (arg) => {
